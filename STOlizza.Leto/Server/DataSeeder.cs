    ...
    public static class DataSeeder
    {
        ...
        private static void AddSmenas(DatabaseContext context)
        {
            ...
            var DefaultSmenaList = new List<SmenaDTO>(){
                ...
                new SmenaDTO(){number = 2, slogan="УЗНАВАЙ", title = "Медиа", description = "Научит создавать инфоповоды и развиваться в медиаполе.", dates = "26-29 июня", color = "#701487", availableTill = "16 июня", isAvailable = true},
