    ...
    public static class DataSeeder
    {
        ...
        private static void AddSmenas(DatabaseContext context)
        {
            ...
            var DefaultSmenaList = new List<SmenaDTO>(){
                ...
                new SmenaDTO(){number = 10, title = "Духовность", description = "Расскажет о религиозной культуре в Москве", dates = "5-8 августа", color = "#01B2E0", isAvailable = true},
                new SmenaDTO(){number = 11, title = "Молодые специалисты", description = "Для молодых управленцев ", dates = "10-13 августа", color = "#01B2E0", isAvailable = true},
                };
